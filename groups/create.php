<?php get_header( 'buddypress' ); ?>
	...
	<div id="content">
		...
		<div class="padder">
			...
			<a href="<?php echo get_option('home'); ?>" class="lien-accueil">
				<div id="creation-retour">
					Revenir à l'accueil
				</div>
			</a>
				...
				<div class="item-body" id="group-create-body">
					...
					<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
						...
						<p class="editfield">
							...
							<input type="text" name="group-desc" id="group-desc" aria-required="true" value="<?php bp_new_group_description(); ?>" />
							* Champ obligatoire
						</p>
