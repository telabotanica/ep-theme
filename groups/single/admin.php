...
<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
	...
	<p class="editfield">
		<label for="group-notifiy-members"><?php _e( 'Notify group members of these changes via email', 'huddle' ); ?></label>
					...
					<li class="<?php bp_group_member_css_class(); ?>">
						...
						<div class="action">
							<?php if ( bp_get_group_member_is_banned() ) : ?>
								...
								<a href="<?php bp_group_member_unban_link() ?>" class="button confirm member-unban" title="<?php _e( 'Unban this member', 'huddle' ) ?>"><?php _e( 'Remove Ban', 'huddle' ); ?></a> &middot; 

							<?php else : ?>

								<a href="<?php bp_group_member_ban_link() ?>" class="button confirm member-ban" title="<?php _e( 'Kick and ban this member', 'huddle' ); ?>"><?php _e( 'Kick &amp; Ban', 'huddle' ); ?></a> &middot; 
								<a href="<?php bp_group_member_promote_mod_link() ?>" class="button confirm member-promote-to-mod" title="<?php _e( 'Promote to Mod', 'huddle' ); ?>"><?php _e( 'Promote to Mod', 'huddle' ); ?></a> &middot; 
								<a href="<?php bp_group_member_promote_admin_link() ?>" class="button confirm member-promote-to-admin" title="<?php _e( 'Promote to Admin', 'huddle' ); ?>"><?php _e( 'Promote to Admin', 'huddle' ); ?></a> &middot; 
