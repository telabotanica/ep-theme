...
<form action="<?php bp_the_profile_group_edit_form_action(); ?>" method="post" id="profile-edit-form" class="standard-form <?php bp_the_profile_group_slug(); ?>">
	...
	<?php do_action( 'bp_before_profile_field_content' ); ?>
		...
		<h4><?php printf( __( "Editing '%s' Profile Group", "huddle" ), bp_get_the_profile_group_name() ); ?></h4>
	...
	<div class="submit">
		<input type="submit" name="profile-group-edit-submit" id="profile-group-edit-submit" value="<?php _e( 'Save Changes', 'huddle' ); ?> " />
	</div>
